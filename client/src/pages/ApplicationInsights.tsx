...
function ResourcePageLayout({ children, title, description, onBack }: {
      ...
      <main className="container py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          <Card className="bg-linear-to-br from-blue-500/10 to-blue-600/5 border-blue-500/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold" aria-live="polite">{data.metrics.total_requests.toLocaleString()}</div>
          ...
          <Card className="bg-linear-to-br from-red-500/10 to-red-600/5 border-red-500/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold" aria-live="polite">{data.metrics.failed_requests.toLocaleString()}</div>
          ...
          <Card className="bg-linear-to-br from-green-500/10 to-green-600/5 border-green-500/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold" aria-live="polite">{data.metrics.availability_percent}%</div>
          ...
          <Card className="bg-linear-to-br from-purple-500/10 to-purple-600/5 border-purple-500/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold" aria-live="polite">{data.metrics.avg_response_time_ms}ms</div>
          ...
          <Card className="bg-linear-to-br from-cyan-500/10 to-cyan-600/5 border-cyan-500/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold" aria-live="polite">{data.metrics.active_users.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground mt-1">Current active sessions</p>
            </CardContent>
          </Card>

          <Card className="bg-linear-to-br from-orange-500/10 to-orange-600/5 border-orange-500/20">
            <CardHeader className="pb-2">
              <CardTitle className="text-xs font-medium text-muted-foreground flex items-center gap-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold" aria-live="polite">{data.metrics.page_views.toLocaleString()}</div>
